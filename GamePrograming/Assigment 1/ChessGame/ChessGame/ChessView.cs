...
namespace ChessGame
{
    class ChessView
    {
        ...
        public ChessView(ChessModel chessModel, ContentManager content, GraphicsDevice device)
        {
            ...
            ChessWhiteSquare = content.Load<Texture2D>("ChessWhiteSquare.png");
            ChessQueenPiece = content.Load<Texture2D>("ChessQueenImage.jpg");
        }
        ...
        public void DrawGame()
        {
            ...
            spriteBatch.Draw(ChessBackground, camera.GetBackgroundVectorPos(), Color.White);
            ...
            //Adding a Pice to test rotation.
